    ...
    func whereWhen (){
        ...
        if closeVenueEvents.count != 0 {
            ...
            if closeVenueEvents[0].distance <= 1 {
                print("The Nearest venue to you is \(closeVenueEvents[0].venue.displayName) and you are within 1000m", terminator: "\n")
                ...
                print("The Nearest venue to you is \(closeVenueEvents[0].venue.displayName) and you are not within 1000m", terminator: "\n")
