...
class MenuTransitionManager: UIPercentDrivenInteractiveTransition, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate, UIViewControllerInteractiveTransitioning {
    ...
    func offStageMenuControllerInteractive(menuViewController: CloseEventSideBarVC){
        ...
        menuViewController.map.transform = self.offStage(offstageOffset)
        menuViewController.lblVenueTitle.transform = self.offStage(offstageOffset)

    }
    
    func onStageMenuController(menuViewController: CloseEventSideBarVC){
        
        // prepare menu to fade in
        menuViewController.view.alpha = 1
        self.statusBarBackground.backgroundColor = UIColor.blackColor()
        
        menuViewController.map.transform = CGAffineTransformIdentity
        menuViewController.lblVenueTitle.transform = CGAffineTransformIdentity
